...
define('DOMAIN_URL', 'https://ecarts.graymatterworks.com/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
define('ALLOW_MODIFICATION', 1);
define('JWT_SECRET_KEY', 'ecart123'); /* chnage to your secret key here set it to anything you like*/
...
class Database
{
    ...
    private $db_user = "u743445510_ecarts"; // Change as required
    private $db_pass = "Ecarts@2024"; // Change as required
    private $db_name = "u743445510_ecarts"; // Change as required
