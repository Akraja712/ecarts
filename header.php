...
<head>
    ...
    <link rel="stylesheet"
        href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.12.1/extensions/filter-control/bootstrap-table-filter-control.css" />
    ...
    <!-- <script src="https://cdn.tiny.cloud/1/ah23qoeaxspmtmdpj7zqklkm9d9ixw15fr2zm9xuxsp3w7rx/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script> -->
    ...
    <div class="wrapper">
        ...
        if ($time_check != $cal_time_check || empty($cal_time_check) || empty($time_check)) {
            ...
            if ($file != 'purchase-code.php') { ?>
                <div class="overlay"
                    style="background: #000000d9; position: absolute; width: 100%; height: 307%; z-index: 9999999;">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="subcategories-order.php"><i class="fa fa-reorder"></i> Sub Categories Order</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="seller-wallet-transactions.php"><i class="fa fa-credit-card"></i> Manage Wallet
                                    Transactions</a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="wallet-transactions.php"><i class="fa fa-exchange"></i> Wallet Transactions</a>
                            </li>
                            <li><a href="manage-customer-wallet.php"><i class="fa fa-line-chart"></i> Manage Customer
                                    Wallet</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                    ...
                    <?php if ($shippint_type) { ?>
                        <li class="treeview delivery_boy">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="delivery-boys.php"><i class="fa fa-line-chart"></i> Manage Delivery Boys </a>
                                </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class=""><a href="#"><i class="fa fa-chevron-circle-down"></i> Footer <i
                            ...
                            <li class="treeview"><a href="front-end-policies.php"><i
                                        class="fa fa-money"></i><span>Policies</span></a></li>
                            <li class="treeview"><a href="scripts.php"><i
                                        class='fa fa-code'></i><span>Scripts</span></a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="payment-methods-settings.php"><i class="fa fa-dollar"></i> Payment Methods </a>
                            </li>
                            <li><a href="time-slots.php"><i class="fa fa-clock-o"></i> Time slots </a></li>
                            <li><a href="notification-settings.php"><i class="fa fa-bell-o"></i> Notification
                                    Settings</a></li>
                            <li><a href="units.php"><i class="fa fa-dot-circle-o"></i> Units</a></li>
                            <li class=""><a href="shipping-methods.php"><i class="fa fa-rocket"></i> Shipping Method</a>
                            </li>
                            ...
                            <li><a href="delivery-boy-privacy-policy.php"><i class="fa fa-exclamation-triangle"></i>
                                    Delivery Boy Privacy Policy </a></li>
                            <li><a href="seller-privacy-policy.php"><i class="fa fa-lock"></i> Seller Privacy Policy
                                </a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="pickup-loacation"><a href="pickup-locations.php"><i
                                        class="fa fa-map"></i></i></i> Pickup Locations </a></li>
                            <li class="location-upload"><a href="location-bulk-upload.php"><i
                                        class="fa fa-upload"></i></i></i>Locations Builk Upload</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="product-sales-report.php"><i class="fa fa-money"></i>Product Sales Report</a>
                            </li>
                    ...
                    if (!empty($result)) {
                        ?>
                        <center><a href="home.php" class="label label-success">
                                <?= $result[0]['version'] ?>
                            </a></center>
                    <?php } ?>
                </ul>
