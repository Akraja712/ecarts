...
if (isset($_POST['btnEdit'])) {
    ...
    $weight = (isset($_POST['weight']) && !empty($_POST['weight'])) ? $_POST['weight'] : 0;
    $length = (isset($_POST['length']) && !empty($_POST['length'])) ? $_POST['length'] : 0;
    $breadth = (isset($_POST['breadth']) && !empty($_POST['breadth'])) ? $_POST['breadth'] : 0;
    $height = (isset($_POST['height']) && !empty($_POST['height'])) ? $_POST['height'] : 0;
    $hsn_code = (isset($_POST['hsn_code']) && !empty($_POST['hsn_code'])) ? $_POST['hsn_code'] : 0;
    ...
    $is_approved = $fn->get_data('products', 'id=' . $id, $columns = ['is_approved']);
...
<section class="content-header">
    ...
    <small><?php echo isset($error['hsn_code']) ? $error['hsn_code'] : ''; ?></small>
                    ...
                    <div class="box-body">
                        ...
                        <div id="variations">
                            ...
                            <div class="row packate_div">
                                ...
                                <div class="col-md-1">
                                    <div class="form-group packate_div">
                                        ...
                                        <input type="number" step="any" min="0" class="form-control"
                                            name="packate_stock[]" value='<?= $row['stock']; ?>' />
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group packate_div">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group"><label>Weight<i
                                                class="text-danger asterik">*</i></label><input type="text"
                                            name="weight[]" value='<?= $row['weight']; ?>'
                                            class="form-control min_value"></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>Lenght</label><input type="text" name="length[]"
                                            value='<?= $row['length']; ?>' class="form-control min_value"></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>Breadth</label><input type="text" name="breadth[]"
                                            value='<?= $row['breadth']; ?>' class="form-control min_value"></div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group"><label>Height</label><input type="text" name="height[]"
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group packate_div">
                                            <label for="exampleInputEmail1">Measurement</label> <i
                                                ...
                                                min="0" class="form-control" name="packate_measurement[]" />
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="form-group packate_div">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group packate_div">
                                            <label for="price">Price (<?= $settings['currency'] ?>):</label> <i
                                                class="text-danger asterik">*</i> <input type="number" step="any"
                                                min="0" class="form-control" name="packate_price[]"
                                                id="packate_price" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group"><label>Breadth</label><input type="text"
                            ...
                            <div class="row loose_div">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group loose_div">
                                        <label for="exampleInputEmail1">Measurement</label> <i
                                            class="text-danger asterik">*</i>
                                        <input type="number" step="any" min="0" class="form-control"
                                            name="loose_measurement[]"="" value='<?= $row['measurement']; ?>'>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group loose_div">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group loose_div">
                                        <label for="price">Price (<?= $settings['currency'] ?>):</label> <i
                                            class="text-danger asterik">*</i>
                                        <input type="number" step="any" min="0" class="form-control"
                                            name="loose_price[]" id="loose_price"="" value='<?= $row['price']; ?>'>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group loose_div">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group"><label>Lenght</label><input type="text"
                                ...
                                <div class="col-md-1">
                                    <div class="form-group"><label>Height</label><input type="text"
                            ...
                            <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group" style="margin-top:18px">
                                                    ...
                                                    <select name='pincode_ids_exc[]' id='pincode_ids_exc'
                                                        style="width:520px" class='form-control'
                                                        ...
                                                        <option value='<?= $value['id'] ?>'
                                                            <?= (strpos(" " . $res[0]['pincodes'], $value['id'])) ? 'selected' : ''; ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="till_status" name="till_status" class="form-control">
                                                ...
                                                <option value="shipped"
                                                    <?= $res[0]['till_status'] == 'shipped' ? 'selected' : '' ?>>Shipped
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 d-none">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" class="form-control"
                                                ...
                                                value="<?= isset($res[0]['total_allowed_quantity']) && $res[0]['total_allowed_quantity'] != '' ? $res[0]['total_allowed_quantity'] : 0 ?>" />
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <a class='btn btn-xs btn-danger delete-image' data-seller_id='<?= $seller_id; ?>'
                                        data-i='<?= $i; ?>' data-pid='<?= $_GET['id']; ?>'>Delete</a>
                                    <?php }
                                    } ?>
                                </div>
                                <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="standard_shiping_info_modal">
                        ...
                        <a href="<?= DOMAIN_URL ?>seller/pickup-locations.php" target="_blank">click</a> here to get
                        detais of pickup locations
                    ...
                    <p class="local_shiping_info_modal">
                        ...
                        <a href="<?= DOMAIN_URL ?>seller/areas.php" target="_blank">click</a> here to get detais of
                        Pincodes
                        <br>
                        <br>
