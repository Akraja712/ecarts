        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?= ((defined('ALLOW_MODIFICATION')) && (ALLOW_MODIFICATION == 0) || !($function->get_seller_permission($_SESSION['seller_id'], 'customer_privacy'))) ? $str_to_replace . substr($user_address[0]['mobile'], 7) : $user_address[0]['mobile']; ?>
                            </td>
                        </tr>
                        <th style="width: 10px">Email</th>
                        <td><?= defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0 || !($function->get_seller_permission($_SESSION['seller_id'], 'customer_privacy')) ? $str_to_replace . substr($res[0]['email'], 7) : $res[0]['email']; ?>
                        </td>
                        </tr>
                        <tr>
                            <th style="width: 10px">Contact</th>
                            <td><?= defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0 || !($function->get_seller_permission($_SESSION['seller_id'], 'customer_privacy')) ? $str_to_replace . substr($res[0]['mobile'], 7) : $res[0]['mobile']; ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <?php if (!empty($res[0]['area_id'])) {
                                    ...
                                    $res_areas = $function->get_data('area', 'id = ' . $area_id, '');
                                } else {
                                    $res_areas = $user_address[0]['area'];
                                } ?>
                            <td><?php print_r((!empty($res_areas[0]['name'])) ? $res_areas[0]['name'] : ""); ?></td>
                        </tr>
                        <tr>
                            <th style="width: 10px">Pincode</th>
                            <?php $pincode_id = $res[0]['pincode_id'];
                                $res_pincodes = $function->get_data('pincodes', 'id = ' . $pincode_id, ''); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <h5>Standard Shipping Pending Creating orders Order items <a
                                                    data-toggle="modal" data-target="#howtomanage"> How to manage
                                                    shiprocket order ?</a></h5>
                                            <div id="result-shiprocket"></div>
                                        </div>
                                        <div class="col-md-4">
                                            <button type="button" disabled class="btn btn-primary create-shiprocket"
                                    ...
                                    <div class="card col-md-3">
                                        <div class="card-body">
                                            <?php $array[] = $item[8];
                                                                    ...
                                                                    echo "<br><input type='checkbox' data-qty='$item[5]' data-order-item-id=" . $item[10] . " data-product-weight=" . $item[19] . " data-pickup-location=" . $item[18] . "  data-sub-total=" . $test . " name='order_items[]' class='seller_id' data-seller-id=" . $seller_id . " value=" . $item[10] . ">" . "</br>";
                                            ...
                                            <div class="clearfix">
                                                ...
                                                <a class=" col-sm-12 btn btn-success"
                                                    ...
                                                    target='_blank' title="Send Whatsapp Notification"><i
                                            ...
                                            for ($i = 0; $i < count($res); $i++) {
                                                foreach ($items as $item) {
                                                    if ($res[$i]['standard_shipping']) {
                                                        $shiprocket_order = $function->get_data('order_trackings', 'order_item_id=' . $item[10], ['order_item_id,shipment_id,awb_code,is_canceled,courier_company_id,pickup_status,manifests,labels']);
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12  mb-5">
                                <lable class="badge badge-primary">Select status, delivery boy and square box of item
                                    which you want to update</lable>
                                ...
                                <select name='delivery_boy_id' class='form-control deliver_by' required>
                                    ...
                                    <?php if (isset($result[0]) && !empty($result[0])) {
                                                foreach ($result as $row1) {
                                                    ...
                                                    if ($items[15] == $row1['id']) { ?>
                                    <option value='<?= $row1['id'] ?>'><?= $row1['name'] . ' - ' .  $pending_orders ?> -
                            ...
                            <div class="card-body">
                                <?php if ($item[8] == 'received') {
                                                ...
                                                if (!empty($item[14])) {
                                                    ...
                                                    // $delivery_boy_name = $function->get_data('users', 'id = ' . $item[16], ['name']);
                                                    $user_name = isset($user_name[0]['name']) && (!empty($user_name[0]['name'])) ?  $user_name[0]['name'] : "";
                                                }
                ...
                <input type="hidden" name="total_amount" id="total_amount"
                    value="<?= intval($order_total + $res[0]['delivery_charge']); ?>">
                <tr>
                    ...
                    <td><input type="number" class="form-control" id="final_total" name="final_total"
                            value="<?= intval($order_total + $res[0]['delivery_charge']); ?>" disabled></td>
                </tr>
                <tr>
                ...
                <div class="box-footer clearfix">
                    <?php $check_array = array("awaiting_payment", "cancelled", "returned");
                        ...
                        if (!empty($result1)) { ?>
                    <button class="btn btn-primary pull-right" onclick="myfunction()"><i
                            class="fa fa-download"></i>Generate Invoice</button>
                    <?php } else { ?>
                    <button class="btn btn-primary disabled pull-right"><i class="fa fa-download"></i> Generate
                        Invoice</button>
                    <?php } ?>
                </div>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="number" name="weight" min="<?= $min_weight ?>" class="form-control weight"
                                placeholder="enter weight of parcel" id="">
                        </div>
                        <div class="col-md-3">
                            <label for="">Height </label><small> cms</small>
                            <input type="number" name="hieght" min="<?= $min_height ?>" class="form-control"
                                placeholder="enter weight of parcel" id="">
                        </div>
                        <div class="col-md-3">
                            <label for="">Breadth </label><small> cms</small>
                            <input type="number" name="breadth" min="<?= $min_breadth ?>" class="form-control"
                                placeholder="enter weight of parcel" id="">
                        </div>

                        <div class="col-md-3">
                            <label for="">Length</label><small> cms</small>
                            <input type="number" name="length" min="<?= $min_lenght ?>" class="form-control"
                                placeholder="enter weight of parcel" id="">
                        </div>
                    </div>
...
<div class="modal  fade" id="howtomanage" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <br>
                            <img src="../../documentation/assets/img/send-pickup-request.png" alt=""
                                style="max-width:75%;">
                            <br>
                            4.Track order <br>
                            <br>
                            ...
                            <img src="../../documentation/assets/img/download-manifest-label.png" alt=""
                                style="max-width:75%;">
