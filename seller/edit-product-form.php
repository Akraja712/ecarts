                        ...
                        <div class="form-group">
                            ...
                            <div class='col-md-4'>
                                ...
                                <select id='seller_id' required name="seller_id" class='form-control'>
                                    ...
                                    <option value='<?= $row['id'] ?>'
                                        <?= ($data['seller_id'] == $row['id']) ? 'selected' : ''; ?>><?= $row['name'] ?>
                                    </option>
                                    <?php } ?>
                                </select>
                            </div>
...
$('#add_loose_variation').on('click', function() {
    ...
    html = '<div class="row"><div class="col-md-4"><div class="form-group loose_div">' +
        ...
        '<div class="col-md-1"><div class="form-group"><label>HSN code</label><input type="text" name="hsn_code_loose[]"  class="form-control min_value" min="0.01" onkeyup="min_value(this)"></div></div>' +
...
$('#add_packate_variation').on('click', function() {
    html = '<div class="row"><div class="col-md-2"><div class="form-group packate_div">' +
        ...
        '<div class="col-md-1"><div class="form-group"><label>HSN code</label><input type="text" name="hsn_code[]"  class="form-control min_value" onkeyup="min_value(this)"></div></div>' +
