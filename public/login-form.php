...
$settings = $fn->get_data("settings", "variable = 'system_timezone'");
$settings = json_decode($settings[0]['value'], 1);
...
<div class="col-md-4 col-md-offset-4 " style="margin-top:150px;">
    ...
    <div class='row'>
        <div class="col-md-12 text-center">
            ...
            <h3>
                <?= (isset($settings['app_name'])) ? $settings['app_name'] : "eCart multivendor" ?> - Dashboard
            </h3>
        </div>
