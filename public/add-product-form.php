        ...
        if ($_POST['type'] == "loose") {
            ...
            for ($i = 0; $i < count($_POST['weight_loose']); $i++) {
                if ($_POST['weight_loose'][$i] == 0) {
                    $error['weight_loose'] = "<label class='alert alert-danger'>Weight should be greater then 0.</label>";
                }
                break;
            }
            for ($i = 0; $i < count($_POST['height_loose']); $i++) {
                if ($_POST['height_loose'][$i] == 0) {
                    $error['height_loose'] = "<label class='alert alert-danger'>height should be greater then 0.</label>";
                }
                break;
            }
            for ($i = 0; $i < count($_POST['breadth_loose']); $i++) {
                if ($_POST['breadth_loose'][$i] == 0) {
                    $error['breadth_loose'] = "<label class='alert alert-danger'>breadth should be greater then 0.</label>";
                }
                break;
            }
            for ($i = 0; $i < count($_POST['length_loose']); $i++) {
                if ($_POST['length_loose'][$i] == 0) {
                    $error['length_loose'] = "<label class='alert alert-danger'>length should be greater then 0.</label>";
                }
                break;
            }
        } else {
            for ($i = 0; $i < count($_POST['weight']); $i++) {
                if ($_POST['weight'][$i] == '') {
                    $error['weight'] = "<label class='alert alert-danger'>Weight should be greater then 0.</label>";
                }
                break;
            }
            for ($i = 0; $i < count($_POST['height']); $i++) {
                if ($_POST['height'][$i] == 0) {
                    $error['height'] = "<label class='alert alert-danger'>height should be greater then 0.</label>";
                    break;
                }
            }
            for ($i = 0; $i < count($_POST['breadth']); $i++) {
                if ($_POST['breadth'][$i] == 0) {
                    $error['breadth'] = "<label class='alert alert-danger'>breadth should be greater then 0.</label>";
                    break;
                }
            }
            for ($i = 0; $i < count($_POST['length']); $i++) {
                if ($_POST['length'][$i] == 0) {
                    $error['length'] = "<label class='alert alert-danger'>length should be greater then 0.</label>";
                    break;
                }
            }
        }
                ...
                if ($pincode_type == "all") {
                    ...
                    if ($pincode_type == "all") {
                        ...
                        if (($_POST['product_pincodes'] == "included" || $_POST['product_pincodes'] == "excluded") && !isset($_POST['pincode_ids_exc']) && empty($_POST['pincode_ids_exc'])) {
                            ...
                            $pincode_ids = isset($_POST['pincode_ids_exc'])?$fn->xss_clean_array($_POST['pincode_ids_exc']):'';
                            $pincode_ids = implode(",",array( $pincode_ids));
                        }
                    }
                }
            }
...
<section class="content-header">
    ...
    <small><?= isset($error['hsn_code']) ? $error['hsn_code'] : ''; ?></small>
    ...
    <small><?= isset($error['hsn_code_loose']) ? $error['hsn_code_loose'] : ''; ?></small>
                ...
                <form id='add_product_form' method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 ">
                                    <div class="form-group packate_div">
                                        <label for="exampleInputFile">Variant Images &nbsp;&nbsp;&nbsp;(Please choose
                                            square image of larger than 350px*350px & smaller than 550px*550px.)</label>
                                        <input type="file" name="packet_variant_images[0][]" id="packet_variant_images"
                                            multiple /><br />
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>Weight (kgs)<i
                                            ...
                                            name="weight[]" class="form-control min_value"></div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group"><label>Breadth(cms)</label><input type="text"
                                            name="breadth[]" class="form-control min_value"></div>
                                </div>
                                <div class="col-md-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group loose_div">
                                        <label for="exampleInputFile">Variant Images &nbsp;&nbsp;&nbsp;(Please choose
                                            square image of larger than 350px*350px & smaller than 550px*550px.)</label>
                                        <input type="file" name="loose_variant_images[0][]" id="loose_variant_images"
                                            class="loose_vari_image" multiple /><br />
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>Weight (kgs)<i
                                                class="text-danger asterik">*</i></label><input type="text"
                                            name="weight_loose[]" class="form-control min_value"></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>length(cms)</label><input type="text"
                                            name="length_loose[]" class="form-control min_value"></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>Breadth(cms)</label><input type="text"
                                            name="breadth_loose[]" class="form-control min_value"></div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group"><label>Height(cms)</label><input type="text"
                                            name="height_loose[]" class="form-control min_value"></div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group"><label>HSN code</label><input type="text"
                                            name="hsn_code_loose[]" class="form-control min_value"></div>
                                </div>
                                ...
                                <div class="col-md-06">
                                    <div class="form-group">
                                        <select name="shipping_type" id="shipping_type" class="form-control">
                                            ...
                                            <option value="local" <?= ($shipping_type == 'local') ? 'selected' : '' ?>>
                                                local Shipping</option>
                                            <option value="standard"
                                                <?= ($shipping_type == 'standard') ? 'selected' : '' ?>>Standard
                                                Shipping</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="row local">
                            <div class="">
                                <div class="col-md-4">
                                    <small><a href="#" class="local_shipping_info" data-toggle="modal"
                                            data-target="#exampleModal">What is delivery places?</a></small>
                                    <div class="form-group">
                                        <label for="product_pincodes">Delivery Places :</label><i
                                            class="text-danger asterik">*</i>
                                ...
                                <div class="col-md-4 pincodes">
                                    <div class="form-group " style="margin-top: 18px;">
                                        <label for='pincode_ids_exc'>Select Pincodes <small>( Ex : 100,205, 360 <comma
                                                    separated>
                                                    )</small></label><?php echo isset($error['pincode_ids_exc']) ? $error['pincode_ids_exc'] : ''; ?>
                                        <select name='pincode_ids_exc[]' style="width: 520px;" id='pincode_ids_exc'
                                            class='form-control'
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3" id="return_day" style="display:none">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="any" min="0" class="form-control"
                                        placeholder="Number of days to Return" name="return_days" id="return_days" />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3" id="till-status" style="display:none">
                                <div class="form-group">
                                    <label for="">Till which status? :</label> <i class="text-danger asterik">*</i>
                        ...
                        <div class="form-group">
                            <label for="image">Main Image : <i
                                    class="text-danger asterik">*</i>&nbsp;&nbsp;&nbsp;*Please choose square image of
                                larger than 350px*350px & smaller than
                        ...
                        <div class="form-group">
                            <label for="description">Description :</label> <i class="text-danger asterik">* </i><i
                                id="address_note"></i><?= isset($error['description']) ? $error['description'] : ''; ?>
                            ...
                            if (pickup_locations.length == 1) {
                                pickup_locations.forEach(location => {
                                    seller_pickup_locations =
                                        ...
                                        location.pickup_location + '">' + location.pickup_location +
...
$('#add_packate_variation').on('click', function() {
    html =
        '<div class="row"><div class="col-md-2"><div class="form-group"><label for="measurement">Measurement</label> <i class="text-danger asterik">*</i>' +
        ...
        '<input type="file" name="packet_variant_images[' + i++ +
        ...
        '<div class="col-md-1"><div class="form-group"><label>HSN code</label><input type="text" name="hsn_code[]" onkeyup="min_value(this)"  class="form-control "></div></div>' +
        '</div>';
...
$('#add_loose_variation').on('click', function() {
    html =
        '<div class="row"><div class="col-md-4"><div class="form-group"><label for="measurement">Measurement</label> <i class="text-danger asterik">*</i>' +
        ...
        '<div class="form-group packate_div">' +
        '<label for="exampleInputFile">Variant Images &nbsp;&nbsp;&nbsp;(Please choose square image of larger than 350px*350px & smaller than 550px*550px.)</label>' +
        '<input type="file" name="loose_variant_images[' + i++ +
        '][]" id="loose_variant_images" class="loose_vari_image" multiple /><br />' +
        '</div></div>' +
        ...
        '<div class="col-md-1"><div class="form-group"><label>HSN code</label><input type="text" name="hsn_code_loose[]"  onkeyup="min_value(this)" class="form-control min_value"></div></div>' +
        '</div>';
    $('#variations').append(html);
});
</script>
