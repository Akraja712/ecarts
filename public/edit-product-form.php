...
if (isset($_POST['btnEdit'])) {
    ...
    if ($permissions['products']['update'] == 1) {
        ...
        if ($_POST['type'] == "loose") {
            ...
            // for ($i = 0; $i < count($_POST['hsn_code']); $i++) {
            //     if ($_POST['hsn_code'][$i] == 0) {
            //         $error['hsn_code'] = "<label class='alert alert-danger'>breadth should me greater then 0.</label>";
            //     }
            //     break;
            // }
        ...
        if (!empty($name) && !empty($category_id) && !empty($serve_for) && !empty($description) && empty($error['cancelable']) && empty($error)) {
            ...
            for ($i = 0; $i < $count; $i++) {
                ...
                $vari_image = $fn->get_data('product_variant', 'id=' . $fn->xss_clean($_POST['product_variant_id'][$i]), $columns = ['id', 'images']);
                ...
                if ($_POST['type'] == "packet") {
                    ...
                    $hsn_code = $db->escapeString($fn->xss_clean($_POST['hsn_code'][$i]));
                    ...
                    $db->update('product_variant', 'id=' . $_POST['product_variant_id'][$i], $data);
                    $res = $db->getResult();
                    ...
                    $hsn_code = $db->escapeString($fn->xss_clean($_POST['hsn_code_loose'][$i]));
            ...
            if (
                ...
                for ($i = 0; $i < count($_POST['insert_packate_measurement']); $i++) {
                    ...
                    $sql = "INSERT INTO product_variant (product_id,type,measurement,measurement_unit_id,price,discounted_price,serve_for,stock,stock_unit_id,images,weight,length,breadth,height,hsn_code) VALUES('$product_id','$type','$measurement','$measurement_unit_id','$price','$discounted_price','$serve_for','$stock','$stock_unit_id','$variant_other_images','$weight','$length','$breadth','$height','$hsn_code')";
                    $db->sql($sql);
                }
            }
...
<section class="content-header">
    <h1>Edit Product <small><a href='products.php'> <i class='fa fa-angle-double-left'></i>&nbsp;&nbsp;&nbsp;Back to
                Products</a></small></h1>
    <small><?php echo isset($error['length']) ? $error['length'] : ''; ?></small>
    ...
    <small><?php echo isset($error['length_loose']) ? $error['length_loose'] : ''; ?></small>
    ...
    <small><?php echo isset($error['hsn_code_loose']) ? $error['hsn_code_loose'] : ''; ?></small>
    <small><?php echo isset($error['update_data']) ? $error['update_data'] : ''; ?></small>
    <small><?php echo isset($error['product_pincodes']) ? $error['product_pincodes'] : ''; ?></small>
                ...
                <form id='edit_product_form' method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            ?>
                            <div class='col-md-4'>
                                <label class="control-label" for="seller_id">Seller</label><i
                                    class="text-danger asterik">*</i>
                                <?php $db->sql("SET NAMES 'utf8'");
                                ...
                                ?>
                                <input type="hidden" id="selected_seller_id" value="<?= $data['seller_id'] ?>">
                        ...
                        <div class="form-group">
                            <label class="radio-inline"><input type="radio" name="type" id="packate" value="packet"
                                    <?= ($res[0]['type'] == "packet") ? "checked" : ""; ?>>Packet</label>
                            <label class="radio-inline"><input type="radio" name="type" id="loose" value="loose"
                                    <?= ($res[0]['type'] == "loose") ? "checked" : ""; ?>>Loose</label>
                        </div>
                        <hr>
                        <div id="variations">
                            ...
                            <div class="row packate_div">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group packate_div">
                                        <label for="exampleInputEmail1">Measurement</label> <i
                                            class="text-danger asterik">*</i> <input type="number" step="any" min="0"
                                            class="form-control" name="packate_measurement[]"
                                ...
                                <div class="col-md-2">
                                    <div class="form-group packate_div">
                                        <label for="price">Price (<?= $settings['currency'] ?>):</label> <i
                                            class="text-danger asterik">*</i> <input type="number" step="any" min="0"
                                            class="form-control" name="packate_price[]" id="packate_price"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group packate_div">
                                        <label for="exampleInputFile">Variant Images &nbsp;&nbsp;&nbsp;(Please choose
                                            square image of larger than 350px*350px & smaller than
                                            550px*550px.)</label><?= isset($error['variant_images']) ? $error['variant_images'] : ''; ?>
                                        <input type="file" name="packet_variant_images[<?= $k++; ?>][]"
                                            id="packet_variant_images" multiple
                                        ...
                                        <a class='btn btn-xs btn-danger delete-variant-image'
                                            data-i='<?= $i; ?>'>Delete</a>
                                        <?php }
                                                } ?>
                                    </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group"><label>Weight (kgs)<i
                                                class="text-danger asterik">*</i></label><input type="text"
                                            name="weight[]" value='<?= $row['weight']; ?>'
                                            class="form-control min_value"></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>length(cms)</label><input type="text" name="length[]"
                                            value='<?= $row['length']; ?>' class="form-control min_value"></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>Breadth(cms)</label><input type="text"
                                            name="breadth[]" value='<?= $row['breadth']; ?>'
                                            class="form-control min_value"></div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group"><label>Height(cms)</label><input type="text" name="height[]"
                                            value='<?= $row['height']; ?>' class="form-control min_value"></div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group"><label>HSN code</label><input type="text" name="hsn_code[]"
                                            value='<?= $row['hsn_code']; ?>' class="form-control min_value"></div>
                                </div>
                            ...
                            <div id="packate_div" style="display:none">
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group packate_div">
                                            <label for="exampleInputEmail1">Measurement</label> <i
                                                class="text-danger asterik">*</i> <input type="number" step="any"
                                                min="0" class="form-control " name="packate_measurement[]" required />
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="form-group packate_div">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group packate_div">
                                            ...
                                            <input type="number" step="any" min="0" class="form-control"
                                                name="packate_price[]" id="packate_price" required />
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="form-group packate_div">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group packate_div">
                                            <label for="exampleInputFile">Variant Other Images <i
                                                    class="text-danger asterik">*</i> &nbsp;&nbsp;&nbsp;*Please choose
                                                square image of larger than 350px*350px & smaller than
                                                550px*550px.</label><?= isset($error['variant_images']) ? $error['variant_images'] : ''; ?>
                                            <input type="file" name="packet_variant_images[<?= $k++; ?>][]"
                                                id="packet_variant_images" multiple /><br />
                                            <?php if (!empty($row['variant_images'])) {
                                                    $variant_images = str_replace("'", '"', $row['variant_images']);
                                                    $variant_images = json_decode($variant_images);
                                                    for ($i = 0; $i < count($variant_images); $i++) { ?>
                                            <img src="<?= $variant_images[$i]; ?>" height="160" />
                                            <a class='btn btn-xs btn-danger delete-variant-image' data-i='<?= $i; ?>'
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group"><label>length(cms)</label><input type="text"
                                                name="length[]" value='<?= $row['length']; ?>'
                                                class="form-control min_value"></div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group"><label>Breadth(cms)</label><input type="text"
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group"><label>Height(cms)</label><input type="text"
                                                name="height[]" value='<?= $row['height']; ?>'
                                                class="form-control min_value"></div>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="form-group"><label>HSN code</label><input type="text"
                                                name="hsn_code[]" value='<?= $row['hsn_code']; ?>'
                                                class="form-control min_value"></div>
                                    </div>
                            ...
                            <div class="row loose_div">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group loose_div">
                                        <label for="exampleInputEmail1">Measurement</label> <i
                                            class="text-danger asterik">*</i>
                                        <input type="number" step="any" min="0" class="form-control"
                                            name="loose_measurement[]" required="" value='<?= $row['measurement']; ?>'>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group loose_div">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group loose_div">
                                        <label for="exampleInputFile">Variant Other Images <i
                                            ...
                                            square image of larger than 350px*350px & smaller than
                                            550px*550px.</label><?= isset($error['variant_images']) ? $error['variant_images'] : ''; ?>
                                        <input type="file" name="loose_variant_images[<?= $j++; ?>][]"
                                            id="loose_variant_images" multiple
                                            title="Please choose square image of larger than 350px*350px & smaller than 550px*550px." /><br />
                                        <?php if (!empty($row['variant_images'])) {
                                                    $variant_images = str_replace("'", '"', $row['variant_images']);
                                                    $variant_images = json_decode($variant_images);
                                ...
                                <div class="col-md-2">
                                    <div class="form-group"><label>Weight (kgs)<i
                                                class="text-danger asterik">*</i></label><input type="text"
                                            name="weight_loose[]" value='<?= $row['weight']; ?>'
                                            class="form-control min_value"></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>length(cms)</label><input type="text"
                                            name="length_loose[]" value='<?= $row['length']; ?>'
                                            class="form-control min_value"></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group"><label>Breadth(cms)</label><input type="text"
                                            name="breadth_loose[]" value='<?= $row['breadth']; ?>'
                                            class="form-control min_value"></div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group"><label>Height(cms)</label><input type="text"
                                            name="height_loose[]" value='<?= $row['height']; ?>'
                                            class="form-control min_value"></div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group"><label>HSN code</label><input type="text"
                                            name="hsn_code_loose[]" value='<?= $row['hsn_code']; ?>'
                                            class="form-control min_value"></div>
                                </div>
                            </div>
                            <?php } ?>
                            ...
                            <div class="form-group" id="loose_stock_div" style="display:block;">
                                <label for="quantity">Stock :</label> <i class="text-danger asterik">*</i>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" id="selected_subcategory_id"
                                            value="<?= $res[0]['subcategory_id'] ?>">
                                        ...
                                        <select name="subcategory_id" id="subcategory_id" class="form-control">
                                            ...
                                            <option value="<?= $subcategories['id']; ?>"
                                                <?= $res[0]['subcategory_id'] == $subcategories['id'] ? 'selected' : '' ?>>
                                    ...
                                    <div class="row offset-col-2">
                                        <div class="col-md-4">
                                            <label for="">Select Shipping Type :</label><i
                                                class="text-danger asterik">*</i>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="col-md-06">
                                                <div class="form-group">
                                                    <select name="shipping_type" id="shipping_type"
                                                        ...
                                                        <option value="local"
                                                            <?= ($res[0]['standard_shipping'] == 0) ? 'selected' : '' ?>>
                                                            local Shipping</option>
                                                        <option value="standard"
                                                            <?= ($res[0]['standard_shipping'] == 1) ? 'selected' : '' ?>>
                                        ...
                                        <div class="">
                                            <div class="col-md-4">
                                                <div class="form-group" style="margin-top:18px">
                                                    <label for="product_pincodes">Delivery Places <small><a href="#"
                                                                class="local_shipping_info" data-toggle="modal"
                                                                data-target="#exampleModal">What is delivery
                                                                places?</a></small>
                                                        :</label><i class="text-danger asterik">*</i>
                                                    <select name="product_pincodes" id="product_pincodes"
                                                        class="form-control" required>
                                                        <option value="">Select Option</option>
                                                        <option value="included"
                                                            <?= (!empty($res[0]['d_type']) && $res[0]['d_type'] == "included") ? 'selected' : ''; ?>>
                                                            Pincode Included</option>
                                                        <option value="excluded"
                                                            <?= (!empty($res[0]['d_type']) && $res[0]['d_type'] == "excluded") ? 'selected' : ''; ?>>
                                                            Pincode Excluded</option>
                                                        <option value="all"
                                                            <?= (!empty($res[0]['d_type']) && $res[0]['d_type'] == "all") ? 'selected' : ''; ?>>
                                                            Includes All</option>
                                                    </select>
                                                    <br />
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for='pincode_ids_exc'>Selected Pincodes <small>( Ex :
                                                            100,205, 360 <comma separated>)</small></label>
                                                    <select name='pincode_ids_exc[]' id='pincode_ids_exc'
                                                        class='form-control'
                                                        ...
                                                        <option value='<?= $value['id'] ?>'
                                                            <?= (in_array($value['id'], $pincodes)) ? 'selected' : ''; ?>>
                                                            <?= $value['pincode'] ?></option>
                                                        <?php }
                                                        } else {
                                                            foreach ($result as $value) { ?>
                                                        <option value='<?= $value['id'] ?>'><?= $value['pincode'] ?>
                                                        </option>
                                    ...
                                    <div class="row standard ">
                                        <div class="">
                                            <div class="col-md-4 ">
                                                <small><a href="#" class="standard_shipping_info" data-toggle="modal"
                                                        data-target="#exampleModal">What is pickup places?</a></small>

                                                <div class="form-group">

                                                    <label for="product_pincodes">Select Pickup Places :</label><i
                                                        class="text-danger asterik">*</i>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <label id='shipping_error' class="text-danger"></label>
                                                <select name="pickup_location" id='sellers_pickup_locations'
                                                    class="form-control">
                                        ...
                                        <div class="col-md-3" id="return_day" style="<?= $style1; ?>">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="any" min="0" class="form-control"
                                                    ...
                                                    value="<?= $res[0]['return_days'] ?>" name="return_days"
                                                    id="return_days" />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox" id="cancelable_button" class="js-switch"
                                                    <?= $res[0]['cancelable_status'] == 1 ? 'checked' : '' ?>>
                                        ...
                                        <div class="col-md-3" id="till-status" style="<?= $style; ?>">
                                            <div class="form-group">
                                                <label for="">Till which status? :</label> <i
                                                    class="text-danger asterik">*</i>
                                                <?php echo isset($error['cancelable']) ? $error['cancelable'] : ''; ?><br>
                                                <select id="till_status" name="till_status" class="form-control">
                                                    <option value="">Select</option>
                                                    <option value="received"
                                                        <?= $res[0]['till_status'] == 'received' ? 'selected' : '' ?>>
                                                        Received</option>
                                                    <option value="processed"
                                                        <?= $res[0]['till_status'] == 'processed' ? 'selected' : '' ?>>
                                                        Processed</option>
                                                    <option value="shipped"
                                                        <?= $res[0]['till_status'] == 'shipped' ? 'selected' : '' ?>>
                                                        Shipped</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox" id="cod_allowed_button" class="js-switch"
                                                    <?= isset($res[0]['cod_allowed']) && $res[0]['cod_allowed'] == 1 ? 'checked' : '' ?>>
                                                <input type="hidden" id="cod_allowed_status" name="is_cod_allowed"
                                                    value="<?= isset($res[0]['cod_allowed']) && $res[0]['cod_allowed'] == 1 ? 1 : 0 ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">Total allowed quantity : <small>[Keep blank if no such
                                                        limit]</small></label>
                                                <input type="number" min="1" class="form-control"
                                                    name="max_allowed_quantity"
                                                    value="<?= isset($res[0]['total_allowed_quantity']) && !empty($res[0]['total_allowed_quantity']) ? $res[0]['total_allowed_quantity'] : '' ?>" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputFile">Image <i class="text-danger asterik">*</i>
                                    ...
                                    <div class="form-group">
                                        <label for="description">Description :</label> <i
                                            class="text-danger asterik">*</i><i id="address_note"></i>
                                        <?= isset($error['description']) ? $error['description'] : ''; ?>
                                        <textarea name="description" id="description" class="form-control addr_editor"
                                            rows="16"><?= $data['description']; ?></textarea>
                                    </div>
                                    <div class="row">
                                                ...
                                                <div id="status" class="btn-group">
                                                    <label class="btn btn-default" data-toggle-class="btn-primary"
                                                        ...
                                                        <input type="radio" name="is_approved" value="0"
                                                            <?= ($data['is_approved'] == 0) ? 'checked' : ''; ?>>
                                                        Not-Processed
                                                    </label>
                                                    <label class="btn btn-primary" data-toggle-class="btn-primary"
                                                        data-toggle-passive-class="btn-default">
                                                        <input type="radio" name="is_approved" value="1"
                                                            <?= ($data['is_approved'] == 1) ? 'checked' : ''; ?>>
                                                        Approoved
                                                    </label>
                                                    <label class="btn btn-danger" data-toggle-class="btn-danger"
                                                        data-toggle-passive-class="btn-default">
                                                        <input type="radio" name="is_approved" value="2"
                                                            <?= ($data['is_approved'] == 2) ? 'checked' : ''; ?>>
                                                        Not-Approoved
                                                    </label>
                                                </div>
                                            </div>
                            ...
                            <div class="box-footer">
                                <input type="submit" class="btn-primary btn" id="btnEdit" value="Update"
                                    name="btnEdit" />
                            </div>
                </form>
            </div><!-- /.box -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="standard_shiping_info_modal">
                        ...
                        Get your products delivered faster at your customers' doorstep by selecting the pickup location
                        nearest to your buyer's address. It helps in faster delivery by eliminating the extra transit
                        time
                        <a href="https://www.shiprocket.in/features/multiple-pick-up-locations/" target="_blank">know
                            more.</a>
                        <br>
                        <br>
                        <b>How to get pickup location ?</b><br>
                        <a href="<?= DOMAIN_URL ?>/pickup-locations.php" target="_blank">click</a> here to get detais of
                        pickup locations
                    ...
                    <p class="local_shiping_info_modal">
                        ...
                        <b>Type:</b>
                        <br>
                        <b>1. Included:</b>in this type you can select where spesific pincode you will deliver orders to
                        customers <br>
                        <b>2. Excluded:</b>in this type you can select where spesific pincode you will not deliver
                        orders to customers <br>
...
$(document).ready(function() {
    ltr =
        '<svg width="20" height="20"><path d="M11 5h7a1 1 0 010 2h-1v11a1 1 0 01-2 0V7h-2v11a1 1 0 01-2 0v-6c-.5 0-1 0-1.4-.3A3.4 3.4 0 017.8 10a3.3 3.3 0 010-2.8 3.4 3.4 0 011.8-1.8L11 5zM4.4 16.2L6.2 15l-1.8-1.2a1 1 0 011.2-1.6l3 2a1 1 0 010 1.6l-3 2a1 1 0 11-1.2-1.6z" fill-rule="evenodd"></path></svg>';
    rtl =
        '<svg width="20" height="20"><path d="M8 5h8v2h-2v12h-2V7h-2v12H8v-7c-.5 0-1 0-1.4-.3A3.4 3.4 0 014.8 10a3.3 3.3 0 010-2.8 3.4 3.4 0 011.8-1.8L8 5zm12 11.2a1 1 0 11-1 1.6l-3-2a1 1 0 010-1.6l3-2a1 1 0 111 1.6L18.4 15l1.8 1.2z" fill-rule="evenodd"></path></svg>';
                                ...
                                pickup_locations.forEach(location => {
                                    if (old_pickup_location == location.pickup_location) {
                                        seller_pickup_locations =
                                            '<option class="appended-options" selected  value="' +
                                            location.pickup_location + '">' + location
                                            .pickup_location + ' ' + location.pin_code +
                                            '</option>';
                                        $('#sellers_pickup_locations').append(
                                            seller_pickup_locations)
                                    } else {
                                        seller_pickup_locations =
                                            '<option class="appended-options"  value="' + location
                                            .pickup_location + '">' + location.pickup_location +
                                            ' ' + location.pin_code + '</option>';
                                        $('#sellers_pickup_locations').append(
                                            seller_pickup_locations)
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            if ($('#selected_category_id').val() != "") {
                ...
                $('#category_id').val($('#selected_category_id').val());
...
function min_value(element) {
    if ($(element).val() <= 0) {
        ...
        $(element).parent().append(
            '<span class="text-danger error_status">value shoud be not less then or equal to zero</span>');
...
$(document).ready(function() {
    var seller_id = "";
    if ($('#selected_seller_id').val() != "") {
        seller_id = $('#selected_seller_id').val();
        $('#seller_id').val($('#selected_seller_id').val());
    }
    ...
    $.ajax({
        ...
        success: function(result) {
            $('#category_id').html(result);
            if ($("#selected_category_id").val() != "") {
                $('#category_id').val($("#selected_category_id").val()).trigger("change");
            }
        }
    })
    fetchPickup_locations(standard_shipping, seller_id)
...
$('#product_pincodes').on('change', function() {
    ...
    if (val == "included" || val == "excluded") {
        $('#pincode_ids_exc').prop('disabled', false);
        $('#pincode_ids_exc').attr('required', true);
    } else {
        $('#pincode_ids_exc').prop('disabled', true);
        $('#pincode_ids_exc').attr('required', false);
    }
});
...
$('#add_loose_variation').on('click', function() {
    ...
    html = '<div class="row"><div class="col-md-4"><div class="form-group loose_div">' +
        '<label for="exampleInputEmail1">Measurement</label> <i class="text-danger asterik">*</i> <input type="number" step="any" min="0_" class="form-control" name="insert_loose_measurement[]" required="">' +
        '</div></div>' +
        ...
        '<input type="file" name="insert_loose_variant_images[' + x++ +
        '][]" id="insert_loose_variant_images" multiple title="Please choose square image of larger than 350px*350px & smaller than 550px*550px." /><br />' +
        '</div></div>' +

        '<div class="col-md-2"><div class="form-group"><label>Weight (kgs)<i class="text-danger">*</i></label><input type="text" name="weight_loose[]" class="form-control min_value" min="0.01" onkeyup="min_value(this)"></div></div>' +
        '<div class="col-md-2"><div class="form-group"><label>Length(cms)</label><input type="text"  name="length_loose[]" class="form-control min_value" min="0.01" onkeyup="min_value(this)"></div></div>' +
        '<div class="col-md-2"><div class="form-group"><label>Breadth(cms)</label><input type="text"  name="breadth_loose[]" class="form-control min_value" min="0.01" onkeyup="min_value(this)"></div></div>' +
        '<div class="col-md-1"><div class="form-group"><label>Height(cms)</label><input type="text" name="height_loose[]"  class="form-control min_value" min="0.01" onkeyup="min_value(this)"></div></div>' +
...
$('#add_packate_variation').on('click', function() {
    html = '<div class="row"><div class="col-md-2"><div class="form-group packate_div">' +
        ...
        '<label for="exampleInputFile">Variant Other Images <i class="text-danger asterik">*</i> &nbsp;&nbsp;&nbsp;*Please choose square image of larger than 350px*350px & smaller than 550px*550px.</label><?= isset($error['variant_images']) ? $error['variant_images'] : ''; ?>' +
        '<input type="file" name="insert_packet_variant_images[' + x++ +
        '][]" id="insert_packet_variant_images" multiple title="Please choose square image of larger than 350px*350px & smaller than 550px*550px." /><br />' +
        '</div></div>' +

        '<div class="col-md-2"><div class="form-group"><label>Weight (kgs)<i class="text-danger">*</i></label><input type="text" name="weight[]" class="form-control min_value" onkeyup="min_value(this)"></div></div>' +
        '<div class="col-md-2"><div class="form-group"><label>Length(cms)</label><input type="text"  name="length[]" class="form-control min_value" onkeyup="min_value(this)"></div></div>' +
        '<div class="col-md-2"><div class="form-group"><label>Breadth(cms)</label><input type="text"  name="breadth[]" class="form-control min_value" onkeyup="min_value(this)"></div></div>' +
        '<div class="col-md-1"><div class="form-group"><label>Height(cms)</label><input type="text" name="height[]"  class="form-control min_value" onkeyup="min_value(this)"></div></div>' +
...
//             if ($('#selected_subcategory_id').val() != "" && $('#selected_subcategory_id').val() !=
//                 0) {
//                 $('#subcategory_id').val($('#selected_subcategory_id').val());
//             }
//         }
//     });
// });
